    ...
    <div class="px-0 shadow">
      ...
      <div class="p-2">
        <div class="border rounded p-2">
          <table-component :data="visits" :heads="headers" v-if="visits.length" head-class="bg-success text-light">
            ...
            <template v-slot:body="{ item }">
              <td>
                <ul class="nav">
                  <li v-for="(product, i) in item.products" :key="i" class="nav-item">
                    <span>Product : <span class="font-weight-bold">{{ product.name }}</span></span> |
                    <span>Lader :<span class="font-weight-bold">{{ product.lader }}</span></span> |
                    <span>Action :<span class="font-weight-bold">{{ product.action }}</span></span> |
              ...
              <td>
                <router-link :to="`/reports/edit/pm/${item.id}`" class="btn btn-sm btn-warning">
