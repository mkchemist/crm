      ...
      <div class="navbar-collapse collapse" id="rep_navbar">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            <a href="#new_menu" class="nav-link dropdown-toggle" data-toggle="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-left" id="new_menu">
              ...
              <router-link to="/workplaces/add-hospital" class="drop-item small nav-link">
                <span><i class="fa fa-hospital-user"></i></span>
                <span class="ml-1">New hospital</span>
              </router-link>
              <router-link to="/workplaces/add-pharmacy" class="drop-item small nav-link">
                <span><i class="fa fa-store-alt"></i></span>
                <span class="ml-1">New pharmacy</span>
              </router-link>
              <router-link to="/planner/add-pm" class="drop-item small nav-link">
                <span><i class="fa fa-plus-circle"></i></span>
                <span class="ml-1">Plan PM visit</span>
              </router-link>
              <router-link to="/planner/add-am" class="drop-item small nav-link">
                <span><i class="fa fa-plus-circle"></i></span>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" id="user_menu">
              ...
              <a :href="`${base_url}logout`" class="nav-link small dropdown-item">
