<template>
  <div class="p-2 border rounded">
    <h4 class="text-primary mb-0">Non field activity types</h4>
...
export default {
  ...
  methods: {
    ...
    getNonFieldActivityTypes() {
      ...
      return httpCall.get('admin/v1/setting/non-field-activity')
      .then(({data}) => {
     ...
     */
    saveTypes() {
      httpCall.post('admin/v1/setting/non-field-activity', {types: JSON.stringify(this.nonFieldActivityTypes)})
      .then(({data}) => {
