...
<head>
  ...
  <link rel="stylesheet" href="{{ asset("libs/data-tables") }}/Responsive-2.2.7/css/responsive.bootstrap.min.css">
...
<body>
  ...
  <script type="text/javascript" src="{{ asset("libs/data-tables") }}/RowReorder-1.2.7/js/rowReorder.bootstrap4.min.js">
   ...
   <script type="text/javascript" src="{{ asset("libs/data-tables") }}/Responsive-2.2.7/js/dataTables.responsive.min.js">
   </script>
   <script type="text/javascript" src="{{ asset("libs/data-tables") }}/Responsive-2.2.7/js/responsive.bootstrap4.min.js">
   </script>
  ...
  <script src="{{ asset('js/admin/admin.js?v=').$hash_key }}"></script>
  <script src="{{ asset('js/admin/admin-dashboard.min.js') }}"></script>
</body>
