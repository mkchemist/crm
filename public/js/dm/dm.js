      ...
      if (this.withUnlink) {
        buttons.push({
          ...
          action: function action(e, dt) {
            ...
            _helpers_http_service__WEBPACK_IMPORTED_MODULE_0__["httpCall"].post("rep/v1/customers-favorite-list/" + id, {
              _method: "DELETE"
            }).then(function (_ref2) {
              var data = _ref2.data;
      ...
      _c("div", { staticClass: "p-2" }, [
        ...
        _vm.activeCustomers.length
          ? _c(
              ...
              [
                _c("table-component", {
                  attrs: { heads: _vm.heads, data: _vm.activeCustomers }
                })
              ],
              1
            )
...
/* harmony default export */ __webpack_exports__["default"] = (new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  }, _customers_routes__WEBPACK_IMPORTED_MODULE_3__["default"], {
    path: '*',
  ...
  getters: {
    ...
    activeCustomers: function activeCustomers(state) {
      return state.customers.filter(function (customer) {
        return customer.param !== "NN";
      });
    },
    inactiveCustomers: function inactiveCustomers(state) {
      return state.customers.filter(function (customer) {
        return ["NN", "XX"].includes(customer.param);
      });
    },
