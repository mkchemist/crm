...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ["heads", "data", "headClass", "withFavorite", "withUnlink", "onUnlink", "orderBy", "notResponsive", "actionCell"],
  data: function data() {
    return {
      table: null
    };
                      ...
                      _vm._l(_vm.reports, function(report) {
                        return _c("tr", { key: report.id }, [
                          ...
                          _c("td", [
                            _vm._v(
                              _vm._s(
                                report.dual_with ? report.dual_with : "Single"
                              )
                            )
                          ]),
                          _vm._v(" "),
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  getters: {
    ...
    selectedReportRep: function selectedReportRep(state) {
      return state.selected_report_rep;
    }
  },
  mutations: {},
  actions: {
