...
/* harmony import */ var _components_TableComponent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../components/TableComponent */ "./resources/js/components/TableComponent.vue");
/* harmony import */ var _helpers_http_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../helpers/http-service */ "./resources/js/helpers/http-service.js");
/* harmony import */ var _components_ModalFade__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../components/ModalFade */ "./resources/js/components/ModalFade.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    TableComponent: _components_TableComponent__WEBPACK_IMPORTED_MODULE_1__["default"],
    ModalFade: _components_ModalFade__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  data: function data() {
    return {
      heads: [{
  ...
  computed: {
    ...
    areas: function areas() {
      var areas = Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__["filterData"])(this.customers, "area");
      return areas;
    },
  ...
  methods: {
     ...
     */
    addReportToSubmitted: function addReportToSubmitted(id) {
      var checked = event.target.checked;
      ...
      if (checked && !this.submitted_reports.includes(id)) {
        ...
        if (this.submitted_reports.includes(id)) {
          var index = this.submitted_reports.indexOf(id);
     ...
     *
     */
    addAllToSubmiited: function addAllToSubmiited() {
      var _this = this;

      var target = event.target;
      var inputs = document.querySelectorAll('#coach-report-table input[type="checkbox"]');

      if (target.checked) {
        this.reports.map(function (report) {
          if (!report.coach_submit) {
            _this.submitted_reports.push(report.id);
          }
        });
        inputs.forEach(function (input) {
     ...
     *
     */
    submitReports: function submitReports() {
      var _this2 = this;
      ...
      _helpers_http_service__WEBPACK_IMPORTED_MODULE_2__["httpCall"].post("dm/v1/reports/coach/submit", data).then(function (_ref) {
        var data = _ref.data;

        _this2.handleResponse(data, function (data) {
          _this2.$store.dispatch("getCoachingReports", true);
        });
      });
    },
    openRejectModal: function openRejectModal(id) {
      this.show_reject_modal = true;
      this.rejected_report = id;
    },
    rejectCoachReport: function rejectCoachReport() {
      var _this3 = this;
      ...
      var id = this.rejected_report;
      _helpers_http_service__WEBPACK_IMPORTED_MODULE_2__["httpCall"].post("dm/v1/reports/coach/" + id, {
        _method: 'DELETE'
      }).then(function (res) {
        var data = res.data;

        _this3.handleResponse(data, function (data) {
          _this3.rejected_report = false;
          _this3.show_reject_modal = false;

          _this3.$store.dispatch("getCoachingReports", true);
        }, function (data) {
          _this3.rejected_report = false;
          _this3.show_reject_modal = false;
        });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    allReps: function allReps() {
      return Object(_helpers_helpers__WEBPACK_IMPORTED_MODULE_1__["sortBy"])(this.$store.getters.allReps, "name");
    },
    reportByRep: function reportByRep() {
      var _this = this;
      ...
      var reports = this.reports.filter(function (report) {
        return report.user_id === _this.selected_rep;
      });
      return reports;
    }
  },
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/dm/views/reports/ViewCoachAssign.vue?vue&type=style&index=0&id=6a691faa&lang=scss&scoped=true&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--9-2!./node_modules/sass-loader/dist/cjs.js??ref--9-3!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/dm/views/reports/ViewCoachAssign.vue?vue&type=style&index=0&id=6a691faa&lang=scss&scoped=true& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "tr[data-v-6a691faa],\ntd[data-v-6a691faa],\nth[data-v-6a691faa] {\n  vertical-align: middle !important;\n}", ""]);
...
var content = __webpack_require__(/*! !../../../../../node_modules/css-loader!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/src??ref--9-2!../../../../../node_modules/sass-loader/dist/cjs.js??ref--9-3!../../../../../node_modules/vue-loader/lib??vue-loader-options!./ViewCoachAssign.vue?vue&type=style&index=0&id=6a691faa&lang=scss&scoped=true& */ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/dm/views/reports/ViewCoachAssign.vue?vue&type=style&index=0&id=6a691faa&lang=scss&scoped=true&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/dm/views/reports/ViewCoachAssign.vue?vue&type=template&id=6a691faa&scoped=true&":
/*!************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/dm/views/reports/ViewCoachAssign.vue?vue&type=template&id=6a691faa&scoped=true& ***!
  \************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    ...
    [
          ...
          [
            ...
            _c(
              "button",
              {
                ...
                on: {
                  click: function($event) {
                    return _vm.$store.dispatch("getCoachingReports", true)
                  }
                }
              },
              [_vm._m(1), _vm._v(" "), _c("span", [_vm._v("reload list")])]
            ),
            _vm._v(" "),
            _c(
              "button",
              {
                staticClass: "btn btn-sm btn-success",
                attrs: { disabled: !_vm.submitted_reports.length },
                on: { click: _vm.submitReports }
              },
              [_vm._m(2), _vm._v(" "), _c("span", [_vm._v("submit")])]
            )
          ],
          1
        ),
            ...
            _vm.reports.length
                        ...
                        fn: function() {
                          return [
                            _c("th", [
                              _c("input", {
                                attrs: { type: "checkbox" },
                                on: { click: _vm.addAllToSubmiited }
                              })
                            ]),
                            _vm._v(" "),
                          ...
                          return [
                            _c("td", [
                              _c("input", {
                                ...
                                domProps: { checked: item.coach_submit === 1 },
                                on: {
                                  click: function($event) {
                                    return _vm.addReportToSubmitted(item.id)
                                  }
                                }
                              })
                            ]),
              ...
              ? _c("div", [
                  _c("p", { staticClass: "text-center text-muted" }, [
                    _vm._v("No coaching report assigns")
                  ])
                ])
              : _c("loader-component")
          ],
      ...
      _vm._v(" "),
      _c("modal-fade", {
        attrs: { show: _vm.show_reject_modal, id: "reject_modal_fade" },
        scopedSlots: _vm._u([
          {
            key: "header",
            fn: function() {
              ...
              return [
                _c("div", { staticClass: "text-center" }, [
                  _c(
                    ...
                    {
                      staticClass: "btn btn-danger btn-sm",
                      on: { click: _vm.rejectCoachReport }
                    },
                    [
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("span", [_c("i", { staticClass: "fa fa-paper-plane" })])
  }
]
render._withStripped = true
...
var render = function() {
  ...
  return _c("div", { staticClass: "px-0 shadow" }, [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "p-2 row mx-auto" }, [
      _c("div", { staticClass: "col-lg-3 bg-light p-2 rounded" }, [
        _c("div", { staticClass: "border p-2 rounded bg-white" }, [
          _c("label", { attrs: { for: "" } }, [_vm._v("Rep :")]),
          _vm._v(" "),
          _c(
            "select",
            {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.selected_rep,
                  expression: "selected_rep"
                }
              ],
              staticClass: "form-control form-control-sm",
              attrs: { name: "", id: "" },
              on: {
                change: function($event) {
                  ...
                  _vm.selected_rep = $event.target.multiple
                    ? $$selectedVal
                    : $$selectedVal[0]
                }
              }
            ...
            [
              ...
              _vm._v(" "),
              _vm._l(_vm.allReps, function(rep) {
                return _c(
                  "option",
                  { key: rep.id, domProps: { value: rep.id } },
                  [_vm._v(_vm._s(rep.name))]
        ...
        _vm._v(" "),
        _c("div", { staticClass: "my-1 border p-2 rounded bg-white" }, [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "form-group text-right my-2" }, [
            _c(
              "button",
              {
                staticClass: "btn btn-sm btn-primary",
                on: { click: _vm.filterReport }
              },
        ...
        _c(
          "div",
          { staticClass: "p-2 my-1 bg-white rounded border" },
          [
            _c(
              "router-link",
              {
        ...
        [
          _vm.reportByRep.length
            ...
            ? _c(
                ...
                {
                  staticClass:
                    "lead d-flex align-items-center justify-content-center",
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  getters: {
    coachingReports: function coachingReports(state) {
      return state.coaching_reports;
    },
    isCoachingReportsFetched: function isCoachingReportsFetched(state) {
      return state.is_coaching_reports_fetched;
    },
    repReports: function repReports(state) {
      return state.all_rep_reports;
    },
    isRepReportsFetched: function isRepReportsFetched(state) {
      return state.is_rep_reports_fetched;
    },
    selectedReportRep: function selectedReportRep(state) {
      return state.selected_rep_id;
    }
  },
  mutations: {},
  actions: {
    getCoachingReports: function getCoachingReports(_ref, force) {
      var state = _ref.state;

      if (!state.coaching_reports.length || force) {
        state.is_coaching_reports_fetched = false;
        return _helpers_http_service__WEBPACK_IMPORTED_MODULE_0__["httpCall"].get('dm/v1/reports/coach').then(function (_ref2) {
          var data = _ref2.data;
    ...
    getAllReports: function getAllReports(_ref3, force) {
      var state = _ref3.state;

      if (!state.all_rep_reports.length || force) {
        state.is_rep_reports_fetched = false;
        _helpers_http_service__WEBPACK_IMPORTED_MODULE_0__["httpCall"].get('dm/v1/reports/pm').then(function (_ref4) {
          var data = _ref4.data;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ViewCoachAssign_vue_vue_type_template_id_6a691faa_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ViewCoachAssign.vue?vue&type=template&id=6a691faa&scoped=true& */ "./resources/js/dm/views/reports/ViewCoachAssign.vue?vue&type=template&id=6a691faa&scoped=true&");
...
/* empty/unused harmony star reexport *//* harmony import */ var _ViewCoachAssign_vue_vue_type_style_index_0_id_6a691faa_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ViewCoachAssign.vue?vue&type=style&index=0&id=6a691faa&lang=scss&scoped=true& */ "./resources/js/dm/views/reports/ViewCoachAssign.vue?vue&type=style&index=0&id=6a691faa&lang=scss&scoped=true&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _ViewCoachAssign_vue_vue_type_template_id_6a691faa_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _ViewCoachAssign_vue_vue_type_template_id_6a691faa_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "6a691faa",
  null
...
/***/ "./resources/js/dm/views/reports/ViewCoachAssign.vue?vue&type=style&index=0&id=6a691faa&lang=scss&scoped=true&":
/*!*********************************************************************************************************************!*\
  !*** ./resources/js/dm/views/reports/ViewCoachAssign.vue?vue&type=style&index=0&id=6a691faa&lang=scss&scoped=true& ***!
  \*********************************************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_2_node_modules_sass_loader_dist_cjs_js_ref_9_3_node_modules_vue_loader_lib_index_js_vue_loader_options_ViewCoachAssign_vue_vue_type_style_index_0_id_6a691faa_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader!../../../../../node_modules/css-loader!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/src??ref--9-2!../../../../../node_modules/sass-loader/dist/cjs.js??ref--9-3!../../../../../node_modules/vue-loader/lib??vue-loader-options!./ViewCoachAssign.vue?vue&type=style&index=0&id=6a691faa&lang=scss&scoped=true& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/dm/views/reports/ViewCoachAssign.vue?vue&type=style&index=0&id=6a691faa&lang=scss&scoped=true&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_2_node_modules_sass_loader_dist_cjs_js_ref_9_3_node_modules_vue_loader_lib_index_js_vue_loader_options_ViewCoachAssign_vue_vue_type_style_index_0_id_6a691faa_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_2_node_modules_sass_loader_dist_cjs_js_ref_9_3_node_modules_vue_loader_lib_index_js_vue_loader_options_ViewCoachAssign_vue_vue_type_style_index_0_id_6a691faa_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_2_node_modules_sass_loader_dist_cjs_js_ref_9_3_node_modules_vue_loader_lib_index_js_vue_loader_options_ViewCoachAssign_vue_vue_type_style_index_0_id_6a691faa_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_2_node_modules_sass_loader_dist_cjs_js_ref_9_3_node_modules_vue_loader_lib_index_js_vue_loader_options_ViewCoachAssign_vue_vue_type_style_index_0_id_6a691faa_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_2_node_modules_sass_loader_dist_cjs_js_ref_9_3_node_modules_vue_loader_lib_index_js_vue_loader_options_ViewCoachAssign_vue_vue_type_style_index_0_id_6a691faa_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 

/***/ }),

/***/ "./resources/js/dm/views/reports/ViewCoachAssign.vue?vue&type=template&id=6a691faa&scoped=true&":
/*!******************************************************************************************************!*\
  !*** ./resources/js/dm/views/reports/ViewCoachAssign.vue?vue&type=template&id=6a691faa&scoped=true& ***!
  \******************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ViewCoachAssign_vue_vue_type_template_id_6a691faa_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib??vue-loader-options!./ViewCoachAssign.vue?vue&type=template&id=6a691faa&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/dm/views/reports/ViewCoachAssign.vue?vue&type=template&id=6a691faa&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ViewCoachAssign_vue_vue_type_template_id_6a691faa_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ViewCoachAssign_vue_vue_type_template_id_6a691faa_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/*!*****************************************!*\
  !*** ./resources/js/helpers/helpers.js ***!
  \*****************************************/
/*! exports provided: ObjectNotation, filterData, sortBy, ExportToExcel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
