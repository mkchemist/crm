...
.js('resources/js/acc/acc.js', 'public/js/acc')
...
.sass('resources/sass/acc/app.scss', 'public/css/acc')
.sass('resources/sass/admin/admin-dashboard.scss', 'public/css/admin')
